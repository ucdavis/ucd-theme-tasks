...
module.exports = async function patternlab (binPath, args) {
  ...
  const parentPath = binPath.replace('.bin/ucd-theme-tasks', '')
  const patternlab = require(`${parentPath}/@pattern-lab/core`)(plConfig);
